...
function PlainRow({ label, value, currency }: { label: string; value: number; currency: string }) {
  return (
...
function BalanceSheetContent() {
  ...
  // identical figures, not a second calculation.
  ...
  const statementData: SnapshotStatementData = {
    ...
    summary: data
      ? [
          ...
          { label: isBalanced ? 'Balanced ✓' : 'Difference', value: fmt(difference), bold: true },
        ]
      : [],
  };

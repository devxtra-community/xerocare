...
function BalanceSheetContent() {
  ...
  const {
    ...
    queryKey: ['admin-balance-sheet', branchIds],
      ...
      {isLoading ? (
        ...
        <>
          ...
          <p className="text-xs text-muted-foreground text-center">
            Cash &amp; bank from live account balances · Fixed assets from depreciation register
            (NBV) · AR = outstanding invoices (INVOICED status) + manual receivables · VAT payable =
            tax collected on PAID/INVOICED invoices · Equity from equity entries module
          </p>
        </>
      )}
    </div>

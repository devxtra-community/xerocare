...
import { FinanceReplacementsTab } from '@/components/replacement/FinanceReplacementsTab';
...
export default function ContractRenewalsPage() {
  ...
  // Two jobs live on this page now: deciding renewals, and deciding replacements. They
  // share the contract population but nothing else, so they are tabs rather than one
  // merged table.
  const [tab, setTab] = useState<'renewals' | 'replacements'>('renewals');
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {tab === 'renewals'
              ? 'Rent & Lease contracts entering their final billing period — decide renewal and extend from here.'
              : 'Machine replacement requests raised by employees — approve or decline.'}
          </p>
        </div>

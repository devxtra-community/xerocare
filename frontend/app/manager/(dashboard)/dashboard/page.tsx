  ...
  return (
    <div className="bg-blue-100 min-h-full p-3 sm:p-4 md:p-6 space-y-6 sm:space-y-8">
      <div className="flex flex-col space-y-4 sm:space-y-6">
        <h3 className="text-xl sm:text-2xl font-bold text-blue-900">Branch Sales</h3>
        ...
        <div className="space-y-3">
          <h3 className="text-lg sm:text-xl font-bold text-blue-900">Outlet Inventory</h3>
          <DashbordTable />
        </div>
      </div>

      <div className="space-y-2">
        <h3 className="text-lg sm:text-xl font-bold text-blue-900">Branch Sales Overview</h3>
        <BranchSalesChart />
      </div>
    </div>
  );

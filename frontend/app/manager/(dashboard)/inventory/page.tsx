  ...
  return (
    <div className="bg-blue-100 min-h-screen p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="space-y-3 sm:space-y-5">
        <h3 className="text-lg sm:text-xl font-bold text-blue-900">Inventory Management</h3>
        ...
        <div className="space-y-3">
          <h3 className="text-base sm:text-lg font-bold text-blue-900">Product Inventory</h3>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 items-stretch">
          <div className="flex flex-col space-y-3">
            <h4 className="text-base sm:text-lg font-bold text-blue-900">Most Moved Products</h4>
          ...
          <div className="flex flex-col space-y-3">
            <h4 className="text-base sm:text-lg font-bold text-blue-900">Stock by Category</h4>
            <div className="bg-white rounded-xl p-3 flex-1 flex flex-col min-h-[280px]">

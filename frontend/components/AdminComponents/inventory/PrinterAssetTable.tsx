      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-gray-50/50 hover:bg-gray-50/50">
            ...
            <TableHead className="font-semibold text-gray-700 text-center text-blue-600">Active</TableHead>
            <TableHead className="font-semibold text-gray-700 text-center text-green-600">Avail</TableHead>
            <TableHead className="font-semibold text-gray-700 text-center text-red-600">Svc</TableHead>
            <TableHead className="font-semibold text-gray-700 text-center text-orange-500">Idle</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.map((item, idx) => (
            <TableRow key={idx} className="hover:bg-gray-50/50">
              ...
              <TableCell className="text-gray-600">
                <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                    item.category === 'Lease' ? 'bg-purple-100 text-purple-700' :
                    item.category === 'Rental' ? 'bg-blue-100 text-blue-700' :
              ...
              <TableCell className="text-center font-medium text-green-600">{item.available}</TableCell>

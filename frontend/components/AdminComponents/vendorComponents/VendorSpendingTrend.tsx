  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="flex flex-row items-center justify-between pb-4">
        <p className="text-[10px] text-gray-500 font-medium uppercase tracking-wider">Purchase Value Trend</p>
      </div>
      ...
      <div className="flex-1 w-full min-h-[150px]">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <Tooltip 
              contentStyle={{ borderRadius: "8px", border: "none", boxShadow: "0 4px 6px -1px rgb(0 0 0 / 0.1)", padding: "8px", fontSize: "10px" }}

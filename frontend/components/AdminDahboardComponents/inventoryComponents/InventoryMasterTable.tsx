       ...
       <div className="flex-1 overflow-x-auto">
        <Table>
            ...
            <TableRow className="border-b">
                ...
                <TableHead className="text-left text-[10px] sm:text-xs font-semibold text-primary py-1.5 sm:py-2 px-1 sm:px-2">SKU</TableHead>
                <TableHead className="text-left text-[10px] sm:text-xs font-semibold text-primary py-1.5 sm:py-2 px-1 sm:px-2">CATEGORY</TableHead>
                ...
                <TableHead className="text-left text-[10px] sm:text-xs font-semibold text-primary py-1.5 sm:py-2 px-1 sm:px-2">STATUS</TableHead>
                <TableHead className="text-right text-[10px] sm:text-xs font-semibold text-primary py-1.5 sm:py-2 px-1 sm:px-2">ACTION</TableHead>
            </TableRow>
            </TableHeader>
            <TableBody>
            {currentData.map((item, index) => (
                ...
                <TableCell className="py-1.5 sm:py-2 px-1 sm:px-2 text-[10px] sm:text-xs text-gray-700">{item.sku}</TableCell>
                <TableCell className="py-1.5 sm:py-2 px-1 sm:px-2 text-[10px] sm:text-xs text-gray-700">{item.category}</TableCell>
                <TableCell className="py-1.5 sm:py-2 px-1 sm:px-2 text-[10px] sm:text-xs text-gray-700">{item.warehouse}</TableCell>
                <TableCell className="py-1.5 sm:py-2 px-1 sm:px-2 text-[10px] sm:text-xs text-center font-bold text-gray-800">{item.totalStock}</TableCell>

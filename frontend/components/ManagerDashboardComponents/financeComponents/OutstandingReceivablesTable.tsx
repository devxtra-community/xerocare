...
const data = [
  {
    ...
    date: '2024-03-01',
    due: '2024-03-31',
    amount: `${getActiveCurrency()} 12,500`,
    paid: `${getActiveCurrency()} 0`,
    balance: `${getActiveCurrency()} 12,500`,
    aging: '0–30 days',
    status: 'Pending',
  },
  {
    ...
    date: '2023-12-15',
    due: '2024-01-15',
    amount: `${getActiveCurrency()} 28,400`,
    paid: `${getActiveCurrency()} 10,000`,
    balance: `${getActiveCurrency()} 18,400`,
    aging: '60+ days',
    status: 'Overdue',
  },
  {
    ...
    date: '2024-02-10',
    due: '2024-03-10',
    amount: `${getActiveCurrency()} 45,000`,
    paid: `${getActiveCurrency()} 25,000`,
    balance: `${getActiveCurrency()} 20,000`,
    aging: '31–60 days',
    status: 'Partial',
  },
  {
    ...
    date: '2024-03-20',
    due: '2024-04-20',
    amount: `${getActiveCurrency()} 15,200`,
    paid: `${getActiveCurrency()} 0`,
    balance: `${getActiveCurrency()} 15,200`,
    aging: '0–30 days',
    status: 'Pending',
  },
];

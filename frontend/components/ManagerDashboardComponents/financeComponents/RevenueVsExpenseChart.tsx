...
export default function RevenueVsExpenseChart() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-blue-100 p-4 h-full min-h-[260px]">
      <h4 className="text-sm font-bold text-blue-900 uppercase mb-6">Revenue vs Expenses</h4>
        ...
        {isClient && (
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <Bar dataKey="revenue" name="Revenue" fill="#1d4ed8" radius={[4, 4, 0, 0]} barSize={20} />
              <Bar dataKey="expense" name="Expenses" fill="#93c5fd" radius={[4, 4, 0, 0]} barSize={20} />

...
export default function SalesPage() {
  ...
  const filteredProducts = mockProducts.filter((product) => {
    const matchesType = billingType === 'ALL' || product.billingType === billingType;
      ...
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        <div className="flex flex-col gap-3 sm:gap-4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
            <div>
              <h1 className="text-xl sm:text-2xl font-semibold text-primary">Sales Report</h1>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 shadow-sm p-3 sm:p-4 md:p-6">
          <div className="flex flex-col gap-3 sm:gap-4 mb-4 sm:mb-6">
            <h2 className="text-base sm:text-lg font-semibold text-primary">Products Sold</h2>
              ...
              <TableBody>
                {filteredProducts.length ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={7}
                      className="text-center py-6 sm:py-8 text-slate-500 text-xs sm:text-sm"
                    >
                      No products found
                    </TableCell>
                  </TableRow>

...
export default function PerformanceChart({ data, title,centerLabel }: Props) {
  ...
  return (
    <div className="bg-card border shadow-sm rounded-xl p-4 sm:p-5 h-65 sm:h-75 lg:h-85 flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <p className="text-sm text-muted-foreground">{centerLabel ?? "Completed"}</p>
